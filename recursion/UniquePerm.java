...
class UniquePerm{
    ...
    static void perm(String s,int l,int r){
        ...
        for(int i=l;i<=r;i++){
            ...
            s=swap(s,i,r);
            perm(s,l+1,r);
            //to gain the original string say "abc" as it is since we have destorted the sequence in perm
            //so if we don't revert back the other recursive calls will aplly according to the distorted string
            s=swap(s,i,r); 
        }
    }
